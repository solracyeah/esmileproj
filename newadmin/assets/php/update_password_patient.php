...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($update_stmt->execute()) {
        echo "<script>
            ...
            window.location.href = '../../patientlist.html'; // Redirect to a dashboard or desired page
        </script>";
        exit();
    } else {
        echo "<script>
            alert('Error updating password. Please try again later.');
            window.location.href = 'user-profile-patient.php'; // Redirect back to the change password page
        </script>";
        exit();
    }
